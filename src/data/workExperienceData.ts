...
export const workExperienceData: WorkExperienceData[] = [
  {
    companyName: "KBRW",
    timeRange: { french: "Oct 2020 - Aujourd'hui", english: "Oct 2020 - Today" },
    location: "Paris",
    description: {
      french: "Editeur SaaS basé sur le cloud spécialisé en système de gestion de commandes et d'entrepôts. 150 employés",
      english: "Cloud-based SaaS start-up dealing with order and warehouse management systems. 150 employees"
    },
    positions: [
      {
        title: { french: "Tech Lead", english: "Tech Lead" },
        timeRange: { french: "Mai 2025 - Aujourd'hui", english: "May 2025 - Today" },
        tasks: {
          french: [
      ...
      {
        title: { french: "Architecte Solutions", english: "Solutions Architect" },
        timeRange: { french: "Mar 2024 - Aujourd'hui", english: "Mar 2024 - Today" },
        tasks: {
          french: [
      ...
      {
        title: { french: "Lead Ingénieur Solutions", english: "Lead Solution Engineer" },
        timeRange: { french: "Oct 2022 - Mar 2024", english: "Oct 2022 - Mar 2024" },
        tasks: {
          french: [
      ...
      {
        title: { french: "Sr. Développeur Full-stack", english: "Sr. Full-stack Software Engineer" },
        timeRange: { french: "Sep 2021 - Oct 2022", english: "Sep 2021 - Oct 2022" },
        tasks: {
          french: [
            "EBM",
      ...
      {
        title: { french: "Jr. Développeur full-stack", english: "Jr. Full-stack Software Engineer" },
        timeRange: { french: "Oct 2020 - Sep 2021", english: "Oct 2020 - Sep 2021" },
        tasks: {
          french: [
  ...
  },
  {
    ...
    timeRange: { french: "Sep 2019 - Mar 2020", english: "Sep 2019 - Mar 2020" },
    location: "Paris",
    description: {
    ...
    singlePosition: {
      title: { french: "Développeur full-stack junior", english: "Jr. Full-stack Software Engineer" },
      tasks: {
        french: [
  ...
  {
    companyName: "Creads",
    timeRange: { french: "Sep 2017 - Sep 2018", english: "Sep 2017 - Sep 2018" },
    location: "Paris",
    description: {
      french: "Plateforme de mise en relation entre créatifs freelances et clients. 40 employés",
      english: "Digital matching platform for freelancing designers and businesses. 40 employees"
    },
    singlePosition: {
      title: { french: "Développeur full-stack junior", english: "Jr. Full-stack Software Engineer" },
      tasks: {
  ...
  },
  {
    ...
    timeRange: { french: "Fev 2021 - Mar 2022", english: "Feb 2021 - Mar 2022" },
    location: "Paris",
    description: {
      french: "Plateforme de mise en relation, réservation & visio-conférence pour tout type de coaching",
      english: "Digital platform to help coaches with appointment management, payment and video-conference."
    },
    singlePosition: {
