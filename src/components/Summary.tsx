  ...
  return (
    <div className="summary bg-gradient-to-r from-cv-primary to-cv-secondary text-white p-5 mb-4 rounded-xl shadow-lg">
      ...
      <div className="summary-resume text-base text-blue-50 leading-relaxed max-w-4xl">
        {isFrench
          ? "Solutions Architect expérimenté ayant dirigé une équipe de 15 développeurs et supervisé architecturalement 20+ ingénieurs sur des projets stratégiques CAC40. Expert en systèmes critiques haute disponibilité et transformation digitale. Je combine expertise technique approfondie en Elixir/React/DevOps et leadership d'équipe pour créer des solutions durables et performantes."
